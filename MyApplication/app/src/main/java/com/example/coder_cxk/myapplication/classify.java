...
public class classify {
    ...
    private static int classify(String img_file) {
        try {
            ...
            if (tokens.length == 2 || tokens.length == 3) {
                if (!tokens[0].equals(CLA_RESULT)) {
                    System.err.println("Wrong response: " + tokens[1]);
                    socket.close();
                    return -1;
                }
    ...
    public static String get_result(String img_file) {
        int number = -1;
        for (int i = 0; i < RETRY_TIME; ++i)
            if (number == -1)
                number = classify(img_file);
            else
                break;


        System.out.println("Result index: " + number);

        if (number == -1)
            return "# Connect server errror";
        else if (number == -2)
            return "# Unrecognized file format";
        else if (number <= 110)
            return flower_label[number];
        else
            return "~ " + all_label[number - 110];
    }

    private static final String[] flower_label = {"pink primrose", "hard-leaved pocket orchid", "canterbury bells", "sweet pea", "english marigold", "tiger lily", "moon orchid", "bird of paradise", "monkshood", "globe thistle", "snapdragon", "colt's foot", "king protea", "spear thistle", "yellow iris", "globe-flower", "purple coneflower", "peruvian lily", "balloon flower", "giant white arum lily", "fire lily", "pincushion flower", "fritillary", "red ginger", "grape hyacinth", "corn poppy", "prince of wales feathers", "stemless gentian", "artichoke", "sweet william", "carnation", "garden phlox", "love in the mist", "mexican aster", "alpine sea holly", "ruby-lipped cattleya", "cape flower", "great masterwort", "siam tulip", "lenten rose", "barbeton daisy", "daffodil", "sword lily", "poinsettia", "bolero deep blue", "wallflower", "marigold", "buttercup", "oxeye daisy", "common dandelion", "petunia", "wild pansy", "primula", "sunflower", "pelargonium", "bishop of llandaff", "gaura", "geranium", "orange dahlia", "pink-yellow dahlia?", "cautleya spicata", "japanese anemone", "black-eyed susan", "silverbush", "californian poppy", "osteospermum", "spring crocus", "bearded iris", "windflower", "tree poppy", "gazania", "azalea", "water lily", "rose", "thorn apple", "morning glory", "passion flower", "lotus", "toad lily", "anthurium", "frangipani", "clematis", "hibiscus", "columbine", "desert-rose", "tree mallow", "magnolia", "cyclamen ", "watercress", "canna lily", "hippeastrum ", "bee balm", "ball moss", "foxglove", "bougainvillea", "camellia", "mallow", "mexican petunia", "bromelia", "blanket flower", "trumpet creeper", "blackberry lily"};


    private static final String[] all_label = {"tench, Tinca tinca",
