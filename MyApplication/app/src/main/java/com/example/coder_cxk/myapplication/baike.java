...
public class baike extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.baike, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_identify) {
            ...
            intent.setClass(baike.this, identify.class);
            baike.this.startActivity(intent);
        } else if (id == R.id.nav_baike) {
            Intent intent = new Intent();
            intent.setClass(baike.this, baike.class);
            baike.this.startActivity(intent);

        } else if (id == R.id.nav_main) {
            Intent intent = new Intent();
            intent.setClass(baike.this, MainActivity.class);
            baike.this.startActivity(intent);
            ...
            Intent intent = new Intent();
            intent.setClass(baike.this, guessflower.class);
            baike.this.startActivity(intent);
        }
